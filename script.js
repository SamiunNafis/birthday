...
let q = new URLSearchParams(window.location.search).get('name')
q = q || "user"
...
Firework.prototype.draw = function() {
	...
	setTimeout(() => {
		...
		text.innerHTML = 'WISHING YOU MANY MANY HAPPY RETURNS OF THE DAY'
...
function loop() {
    ...
    if (timerTick >= timerTotal) {
        if (!mousedown) {
            ...
            let totalFireworks = (Math.random() * 4) + 1;
